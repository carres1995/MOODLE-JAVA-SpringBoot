...
public class VenueControllerTest {
    ...
    void GetAllVenues() throws Exception {
        Venue venue = new Venue(1L, null, "Riwi", Cities.MEDELLIN);
        Venue venue2 = new Venue(2L, null, "Staf", Cities.CALI);
    ...
    void saveVenues() throws Exception {
        ...
        venue.setName("Riwi");
        venue.setCity(Cities.MEDELLIN);

        Venue savedVenue = new Venue(1L, null, "Riwi", Cities.MEDELLIN);
    ...
    void updateVenue() throws Exception {
        ...
        mockMvc.perform(put("/api/venues/update/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content(mapper.writeValueAsString(venue)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name").value("Riwi"));
